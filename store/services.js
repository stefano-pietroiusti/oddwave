...
export const state = () => ({
  all: [
    ...
    },
    {
      ...
      landing: { header: 'Search Engine Optimization (SEO)', content: 'Be found for the products and services you offer. The Odd Wave will get your business ranking on search engines such as Google and Bing by increasing your website visibility through high quality SEO, content, association and guest posting.' },

const commonKeywords = [
  'seo web design nz company auckland']
export const state = () => ({
  all: [
    {
      id: 'web-design-nz',
      ...
      subheader: 'Goal driven web design and development for results, quality and trust',
    ...
    },
    {
      ...
      header: 'SEO Organic Search Engine Marketing',
      icon: ['fas', 'search'],
    ...
    },
    {
      ...
      landing: { header: 'Website Photography', content: 'Compliment your products, services, websites and digital signage with our professional photographer & creative website photography.' },
    ...
    },
    {
      ...
      maori: 'akoako',
      description: 'Software development services to help out with adhoc web development, data engineering, cloud engineering, cloud development and data analysis.',
      landing: { header: 'Software Development Services', content: 'Partner with us for adhoc web development, data engineering, cloud engineering, cloud development and data analysis.' },
      header: 'Software Development | Web Development | Cloud Development | Data Engineeering | Data Analysis',
      icon: ['fab', 'dev'],
      ...
      backgroundImage: { color1: 'rgba(46, 217, 195, 1)', color2: 'rgba(46, 217, 195, 1)', url: 'webdesign.jpg', height: 'auto' },
      headerStyle: { bgStyle: 'text-secondary text-center' },
      subheader: 'Reliable Contracting from solid work experiences to help your business grow',
      subheaderStyle: { color: 'text-primary', buttonVariant: 'info' },
      content:
        [{

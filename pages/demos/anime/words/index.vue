<template>
  <b-container fluid class="mt-header text-white bg-primary">
    <h1>Word animation</h1>
    <b-row>
      <b-col>
        <h3 class="ml14">
          <span class="letters letters-1">ISLA</span>
          <span class="letters letters-2">Saige</span>
          <span class="letters letters-3">Taiya</span>
          <span class="letters letters-4">Mommy and Pappa</span>
        </h3>
        <h3 class="ml13">
          By The Odd Wave
        </h3>
...
export default {
  ...
  mounted () {
    ...
    textWrapper = document.querySelector('.ml16  .letters')
    textWrapper.innerHTML = textWrapper.textContent.replace(
      /\S/g,
      "<span class='letter'>$&</span>"
    )
    ...
    this.$anime
      .timeline({ loop: true })
      .add({
        targets: '.ml14 .letters-1',
        opacity: ml14.opacityIn,
        scale: ml14.scaleIn,
        duration: ml14.durationIn
      })
      .add({
        targets: '.ml14 .letters-1',
        opacity: 0,
        scale: ml14.scaleOut,
        duration: ml14.durationOut,
        easing: 'easeInExpo',
        delay: ml14.delay
      })
      .add({
        targets: '.ml14 .letters-2',
        opacity: ml14.opacityIn,
        scale: ml14.scaleIn,
        duration: ml14.durationIn
      })

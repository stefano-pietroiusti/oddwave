<template>
  <div class="text-center mt-header w-100">
    ...
    <ImageOverlayComponent :pimage="require('~/static/color-palette.jpeg')" :pcontent="content[1]" />
    <TextComponent :pcontent="content[1]" />
    <ImageBannerComponent
      :pimage="require('~/static/color-spectrum-2.jpg')"
      :pimagedesc="pbannerimagedesc"
      :pimagecontent="content[2]"
    />
    <TextComponent :pcontent="ptextcomponent2" />
    <ImageOverlayComponent :pimage="require('~/static/color-palette.jpeg')" :pcontent="content[3]" />

    <TextComponent :pcontent="content[4]" />
    <!-- <ImageBannerComponent
      :pimage="require('~/static/web-design.jpg')"
      :pimagedesc="pbannerimagedesc"
    />-->
...
export default {
  ...
  data (context) {
    return {
      ...
      pimagecontent3: '',
      pimagecontent4:
        'We can save you money and reach a considerably more significant customer base than traditional marketing methods. We will help you get to know your audience, which creates brand loyalty.',
      pimagecontent5:
        "We will give you the ability to track your marketing efforts with regular reporting and assist ad's management on your behalf and to your specified budget.",
      ptextcomponent1:

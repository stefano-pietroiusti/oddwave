...
.gradient {
  height: 100%;
  width: 100%;
  /* background: repeating-linear-gradient(169deg, #8DFFF7 99%, #F8CBD9 100%, #00978d 0%, #f3b6c9 100%, #00978d 0%, #f3b6c9 100%) no-repeat 50% 50% / 100% 100%; */
...
.bg-feature {
  /* background-image: linear-gradient(white, rgb(243, 239, 239)); */
  border-radius: 11px;
  line-height: 3rem;
  font-weight: 300;

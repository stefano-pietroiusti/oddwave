<!-- eslint-disable vue/no-unused-vars vue/require-v-for-key -->
<template>
  <div>
    <b-card no-body>
      <b-nav slot="header" v-b-scrollspy:nav-scroller pills card-header>
        ...
        <b-nav-item href="#pi0" @click="scrollIntoView">
          @pi0
        </b-nav-item>
      </b-nav>

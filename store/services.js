  ...
  all: [
    {
      ...
      content: [
        ...
        { inlineImage: 'seo.png', text: 'An essential part of a digital marketing strategy is SEO. SEO (Search engine optimization) assists in driving customers to your business via online platforms. SEO assists in making the website rank higher in the SERP (search engine result page) so that your business website is found by customers searching for your product and services online.' },
    ...
    },
    {
      ...
      headerImage: { color1: 'rgba(255, 255, 255, 0.2)', color2: 'rgba(0, 255, 255, 0.5)', url: 'photography.jpg', height: 40 },
      headerStyle: { bgStyle: 'text-primary parralaxEffect' },
      subheader: 'Attract potential customers',
      subheaderStyle: { color: 'text-primary', buttonVariant: 'info' },
      content:
        [

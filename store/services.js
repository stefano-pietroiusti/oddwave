  ...
  all: [
    ...
    // },
    {
      ...
      content: [
        ...
        {
          header: 'SEO Packages',
          text: 'We have various SEO packages to choose from, payable upfront with no fixed contract, and you can cancel anytime.<br/>All Packages include the following:',
          list: [
            'SEO Site Audit',
            'Updated headings, body text, keywords, title, description, meta-tags, body text, links, HTML coding error checks',
            'Site Structure revision and suggestions such as page links, menu and navigation elements, search engine indexing',
            'HTML and XML Site Map generation, robots.txt file creation / revision',
            'The Odd Wave team will carry out all professional SEO services according to Search Engine guidelines'
